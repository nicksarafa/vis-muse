...
const energyMultEl = document.getElementById('energyMult') as HTMLInputElement | null;
const bassMultEl = document.getElementById('bassMult') as HTMLInputElement | null;
const kickMultEl = document.getElementById('kickMult') as HTMLInputElement | null;
